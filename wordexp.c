...
// temove the character at the given index in the given string
...
// checks if a string represents a valid variable name
...
// find index of corresponsing closing quote character whenever an opening quote is found (', " or `)
...
// with the s2 string. end points to the last character to be deleted. returns the malloc'd new string, or NULL on error.
...
// calls other word expansion functions
